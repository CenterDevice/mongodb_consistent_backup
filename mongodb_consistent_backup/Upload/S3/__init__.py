...
def config(parser):
    ...
    parser.add_argument("--upload.s3.target_mb_per_second", dest="upload.s3.target_mb_per_second", default=1000, type=int,
                        help="S3 Uploader target bandwidth. (default: 1000)")
